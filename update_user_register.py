...
class  uregister():
    def __init__(self,res):
        ...
        self.root=Tk()
        self.root.title("Update User Register")
        ...
        self.label=Label(self.root,text="UPDATE USER",bg="#050505",font=('times new roman',15,'bold'),fg='#fcfffd',width=92)
        ...
        self.age_box.insert(0,self.res[2])
        ...
        self.email_box.insert(0,self.res[3])
        ...
        self.pas_box.insert(0,self.res[4])
        ...
        self.wt_box.insert(0,self.res[7])
        ...
        self.ht_box.insert(0,self.res[8])
        ...
        self.ph_box.insert(0,self.res[9])

        
        self.label10=Label(self.root,text="UPDATE YOUR PHOTO",bg="#fcfffd",font=('times new roman',14,'bold'))
    ...
    def getval(self):
        data=(self.name_entry.get(),self.age_box.get(),self.email_box.get(),self.pas_box.get(),self.radiobutton_value.get(),self.dob.get(),self.wt_box.get(),self.ht_box.get(),self.ph_box.get(),self.target_file_path,self.id)
    
        res=database.updateuser(data)  
        if res:
             result= messagebox.showinfo("Updated","User Updated Successfully")
             if result:
                 self.root.destroy()
