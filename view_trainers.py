...
class ViewTrainer():
    ...
    def manageTrainer(self):
        ...
        self.tr.heading('#3', text="Password")
        self.tr.column('#3', minwidth=0, width=80, stretch=NO)

        self.tr.heading('#4', text="Age")
        self.tr.column('#4', minwidth=0, width=30, stretch=NO)
        ...
        self.tr.heading('#7', text="Address")
        self.tr.column('#7', minwidth=0, width=70, stretch=NO)
        
        self.tr.heading('#8', text="Contact")
        self.tr.column('#8', minwidth=0, width=70, stretch=NO)
        
        self.tr.heading('#9', text="Exp.")
        self.tr.column('#9', minwidth=0, width=60, stretch=NO)


        self.tr.heading('#10', text="Delete")
        self.tr.column('#10', minwidth=0, width=60, stretch=NO)

        data = database.getAllTrainers()
        print(data)
        for i in data:
